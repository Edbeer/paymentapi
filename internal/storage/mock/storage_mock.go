...
func (m *MockStorage) CreateAccount(ctx context.Context, req *models.RequestCreate) (*models.Account, error) {
	m.ctrl.T.Helper()
...
func (mr *MockStorageMockRecorder) CreateAccount(ctx, req interface{}) *gomock.Call {
...
func (m *MockStorage) DepositAccount(ctx context.Context, reqDep *models.RequestDeposit) (*models.Account, error) {
	m.ctrl.T.Helper()
...
func (m *MockStorage) GetAccount(ctx context.Context) ([]*models.Account, error) {
	m.ctrl.T.Helper()
...
func (m *MockStorage) GetAccountByID(ctx context.Context, id uuid.UUID) (*models.Account, error) {
	m.ctrl.T.Helper()
...
func (m *MockStorage) UpdateAccount(ctx context.Context, reqUp *models.RequestUpdate, id uuid.UUID) (*models.Account, error) {
	m.ctrl.T.Helper()
